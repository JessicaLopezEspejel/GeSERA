...
def main():
    path_gesera = os.getcwd()
    parser = argparse.ArgumentParser()
    parser.add_argument('-c', type=str, default='test/candidates/',
                        help='candidate documents folder')
    parser.add_argument('-r', type=str, default='test/references/',
                        help='reference documents folder')
    parser.add_argument('-o', type=str, default='test/output/',
                        help='folder where to save results')
    parser.add_argument('-q', type=str, default='raw', help='refine_query')
    parser.add_argument('-t', type=str, default='sera',
                        help='sera_type: sera or dis')
    parser.add_argument('-n', type=int, default=10000,
                        help='number of documents in the index')
    parser.add_argument('-i', type=str, default=None, help='interval')
    parser.add_argument('-p', type=int, default=5, help='cut off point')
    parser.add_argument('-x', type=str, default='wiki', help='index name')
    parser.add_argument('-d', type=str, default=path_gesera +
                        '/data/wiki10000/', help='documents to index')
    parser.add_argument('-s', type=str, default=path_gesera +
                        '/data/index/', help='save index folder')
    ...
    parser_query = QueryParser(
        "content", schema=schema, group=qparser.OrGroup)  # ix.schema
